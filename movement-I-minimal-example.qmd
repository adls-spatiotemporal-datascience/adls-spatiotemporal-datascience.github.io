...
st_layers("data/movement-I/tracks_1.gpkg")


library(dplyr)      # for data manipulation

training_dataset <- read_sf("data/movement-I/tracks_1.gpkg", layer = "training") |> 
  mutate(data = "training")
testing_dataset <- read_sf("data/movement-I/tracks_1.gpkg", layer = "testing") |> 
  mutate(data = "testing")
