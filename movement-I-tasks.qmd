...
Your task is to improve upon the simple model we have built in the chapter [Minimal example](movement-I-minimal-example.qmd#sec-min-ex). You can do this by:
