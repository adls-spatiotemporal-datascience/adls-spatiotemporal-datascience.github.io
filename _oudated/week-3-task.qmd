...
## Task 1 {#sec-task-rast-basic}

Follow the instructions in @sec-gh-pages to create a new repo in the existing organization. As you did last week, solve the next task in a file named `index.qmd`.
