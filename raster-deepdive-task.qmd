...
Follow the instructions in @sec-gh-pages to create a new repo in the existing organization. As you did in the previous weeks, solve the next task in a file named `index.qmd`.
