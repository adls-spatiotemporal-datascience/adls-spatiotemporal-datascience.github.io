...
st_write(grid_dest, "data/vector-deepdive/chessboard.gpkg","grid_dest", append = FALSE)

st_write(grid_orig, "data/vector-deepdive/chessboard.gpkg","grid_orig", append = FALSE)
